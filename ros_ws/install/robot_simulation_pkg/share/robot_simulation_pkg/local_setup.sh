...
: ${AMENT_CURRENT_PREFIX:="/root/ros_ws/install/robot_simulation_pkg"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/robot_simulation_pkg/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/robot_simulation_pkg/environment/path.sh"
